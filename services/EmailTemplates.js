  ...
  const header = `
    ...
    <style>
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .message-content { background: #f8fafc; padding: 20px 10px; border-radius: 12px; border-left: 4px solid ${color1}; color: #374151; white-space: pre-wrap; }
      ...
      <div class="content">
        <div class="contact-card">
          <div class="contact-grid">
            <div class="contact-field" style="margin-bottom: 5px;">
            ...
            <div class="message-field" style="margin-bottom: 5px;">
